...
class TextGenerationPipeline:
    ...
    def select_discourse_planning(self, entry, n_triples):
        ...
        for dp, score in zip(dps, dps_scores):
            print(f'DP: {dp}\n{score}\n')
    ...
    def select_sentence_aggregation(self, dp, n_triples):
        ...
        for sa, score in zip(sas, sas_scores):
            print(f'SA: {sa}\n{score}\n')
    ...
    def score_template(self, t, a):
        ...
        lp = self.length_penalty(preprocessed_text.split())
        score = self.tems_lm_score(preprocessed_text) / lp

        print(f'TEMS: {preprocessed_text}\n{score}\n{lp}\n')
    ...
    def score_text(self, t):
        ...
        score = self.txs_lm_score(preprocessed_text) / lp

        print(f'TXS: {preprocessed_text}\n{score}\n{lp}\n')
